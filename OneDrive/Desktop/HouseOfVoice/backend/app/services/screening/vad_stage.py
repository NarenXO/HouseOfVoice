...
_FALLBACK = {"pause_count": 2, "pause_frequency": 3.5, "speech_ratio": 0.82}
...
async def process_vad(audio_bytes: bytes) -> dict:
    """Detect pauses and compute speech ratio. Falls back gracefully on any error."""
    try:
        import io
        import numpy as np
        ...
        logger.warning(f"[vad_stage] Error: {e}. Using fallback.")
        return dict(_FALLBACK)
