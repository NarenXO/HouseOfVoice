...
_FALLBACK = {"voice_stability": 0.81}


async def process_voice(audio_bytes: bytes) -> dict:
    """Compute voice stability score (0.0–1.0). Falls back gracefully on any error."""
    try:
        import io
        import numpy as np
        ...
        logger.warning(f"[voice_stage] Error: {e}. Using fallback.")
