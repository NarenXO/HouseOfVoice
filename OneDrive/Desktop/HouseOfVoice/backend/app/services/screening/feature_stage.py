...
_FALLBACK = {"speech_rate_wpm": 115.0, "mean_pitch_hz": 210.0, "energy_variance": 0.04}


async def process_features(audio_bytes: bytes, whisper_res: dict) -> dict:
    """Extract acoustic features. Falls back gracefully on any error."""
    try:
        import io
        import numpy as np
        import librosa
        ...
        logger.warning(f"[feature_stage] Error: {e}. Using fallback.")
