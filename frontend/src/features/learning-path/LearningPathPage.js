...
export default function LearningPathPage() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-[#F4F6F8] text-[#0F172A] p-6", children: [_jsx("div", { className: "bg-white border-b border-[#CBD5E1] sticky top-0 z-50", children: _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "flex items-center justify-between h-16", children: [_jsx("h1", { className: "text-2xl font-bold text-[#0F172A]", children: "Learning path" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: () => setActiveTab("roadmap"), className: `px-5 py-2.5 rounded-[8px] font-semibold transition-colors flex items-center gap-2 ${activeTab === "roadmap"
                                            ? "bg-[#1E3A5F] text-white"
                                            : "bg-white text-[#0F172A] border border-[#CBD5E1] hover:bg-[#F4F6F8]"}`, children: "Patient Roadmap" }), _jsx("button", { onClick: () => setActiveTab("edit"), className: `px-5 py-2.5 rounded-[8px] font-semibold transition-colors flex items-center gap-2 ${activeTab === "edit"
                                            ? "bg-[#1E3A5F] text-white"
