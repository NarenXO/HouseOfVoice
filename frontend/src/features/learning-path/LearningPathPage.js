...
export default function LearningPathPage() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-[#F1F5F9] text-[#0F172A] p-6", children: [_jsx("div", { className: "bg-white border-b border-[#CBD5E1] sticky top-0 z-50", children: _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "flex items-center justify-between h-16", children: [_jsx("h1", { className: "text-xl font-bold text-[#0F172A]", children: "Learning path" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: () => setActiveTab("roadmap"), className: `px-5 py-2.5 rounded-[8px] font-semibold transition-colors flex items-center gap-2 ${activeTab === "roadmap"
                                            ? "bg-[#1E3A5F] text-white"
                                            : "bg-white text-[#0F172A] border border-[#CBD5E1] hover:bg-[#F1F5F9]"}`, children: "Patient Roadmap" }), _jsx("button", { onClick: () => setActiveTab("edit"), className: `px-5 py-2.5 rounded-[8px] font-semibold transition-colors flex items-center gap-2 ${activeTab === "edit"
                                            ? "bg-[#1E3A5F] text-white"
                                            : "bg-white text-[#0F172A] border border-[#CBD5E1] hover:bg-[#F1F5F9]"}`, children: "Clinician Mode" })] }), activeTab === "roadmap" && (_jsxs("button", { onClick: handleQuickDemoAutoFill, className: "bg-[#0D9488] hover:bg-[#0F766E] text-white font-semibold rounded-[8px] px-5 py-2.5 shadow-sm transition-colors flex items-center gap-2", children: [_jsx(Zap, { className: "w-4 h-4", strokeWidth: 1.75 }), "Auto-fill practice"] }))] }) }) }), _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: activeTab === "roadmap" ? (_jsxs("div", { children: [_jsx("div", { className: "mb-6", children: _jsx(GeneralizationGauge, { caseId: caseId, refreshTrigger: refreshKey }) }), learningPath.streak && (_jsx(motion.div, { initial: { opacity: 0, y: -8 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-white border border-[#CBD5E1] rounded-[12px] p-4 mb-6 shadow-sm", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Flame, { className: "w-6 h-6 text-[#D97706]", strokeWidth: 1.75 }), _jsxs("div", { children: [_jsxs("div", { className: "font-bold text-lg text-[#0F172A] font-mono tabular-nums", children: ["Streak: ", learningPath.streak.current_streak_days, " days"] }), _jsx("div", { className: "text-sm text-[#475569] font-medium", children: "Practice today to maintain your streak" })] })] }) })), _jsx(Roadmap, { milestones: learningPath.milestones, onMilestoneClick: handleMilestoneClick, onUnlockMilestone: handleUnlockMilestone, progressData: progressData, refreshTrigger: refreshKey }), _jsx(BadgesShowcase, { caseId: caseId, refreshTrigger: refreshKey }), _jsx(AnimatePresence, { children: showCelebration && (_jsx(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -8 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#CCFBF1] border border-[#0D9488] rounded-[12px] p-4 mb-6 text-center shadow-sm", children: _jsxs("div", { className: "flex items-center justify-center gap-2", children: [_jsx(CheckCircle2, { className: "w-5 h-5 text-[#16A34A]", strokeWidth: 1.75 }), _jsx("span", { className: "font-bold text-lg text-[#0F172A]", children: "Badge unlocked" }), _jsx(CheckCircle2, { className: "w-5 h-5 text-[#16A34A]", strokeWidth: 1.75 })] }) })) }), _jsx(MilestoneCard, { milestone: selectedMilestone, onUnlockMilestone: handleUnlockMilestone, caseId: caseId, onProgressUpdate: handleProgressUpdate, onProbeComplete: handleProbeComplete, autoFillTrigger: autoFillTrigger })] })) : (_jsxs("div", { className: "relative", children: [_jsx(MilestoneEditor, { milestones: learningPath.milestones, onUpdateMilestone: handleUpdateMilestone, onAddMilestone: handleAddMilestone, onDeleteMilestone: handleDeleteMilestone, disabled: pathApproved }), !pathApproved && (_jsx("div", { className: "fixed bottom-0 left-0 right-0 bg-white border-t border-[#E2E8F0] p-4 shadow-sm", children: _jsx("div", { className: "max-w-7xl mx-auto flex justify-center", children: _jsxs("button", { onClick: handleApprovePath, className: "bg-[#1E3A5F] hover:bg-[#2E5A88] text-white font-semibold rounded-[8px] px-5 py-2.5 shadow-sm transition-colors flex items-center gap-2", children: [_jsx(CheckCircle2, { className: "w-5 h-5", strokeWidth: 1.75 }), "Approve & Lock Path"] }) }) })), pathApproved && (_jsx(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.2, ease: "easeOut" }, className: "fixed bottom-0 left-0 right-0 bg-[#CCFBF1] border border-[#0D9488] text-[#0F172A] p-4 shadow-sm", children: _jsxs("div", { className: "max-w-7xl mx-auto flex items-center justify-center gap-3", children: [_jsx(CheckCircle2, { className: "w-6 h-6 text-[#16A34A]", strokeWidth: 1.75 }), _jsx("span", { className: "font-bold text-lg text-[#0F172A]", children: "Path is live and approved" }), _jsx(CheckCircle2, { className: "w-6 h-6 text-[#16A34A]", strokeWidth: 1.75 })] }) }))] })) })] }));
}
