...
export default function LearningPathPage() {
    ...
    return (_jsx("div", { className: "min-h-screen bg-[#E8F8F3] text-[#0F172A] p-6", children: _jsxs("div", { className: "max-w-6xl mx-auto", children: [_jsxs("div", { className: "bg-white border-2 border-[#059669] rounded-[16px] p-4 shadow-sm mb-6 sticky top-4 z-50 flex items-center justify-between", children: [_jsx("h1", { className: "text-2xl font-black text-[#022C22] tracking-tight", children: "Learning path" }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: () => setActiveTab("roadmap"), className: `px-4 py-2 rounded-lg font-bold transition-colors flex items-center gap-2 ${activeTab === "roadmap"
                                                ? "bg-[#059669] text-white"
                                                : "bg-white text-[#022C22] border border-[#059669] hover:bg-[#F0FDF4]"}`, children: "Patient Roadmap" }), _jsx("button", { onClick: () => setActiveTab("edit"), className: `px-4 py-2 rounded-lg font-bold transition-colors flex items-center gap-2 ${activeTab === "edit"
                                                ? "bg-[#059669] text-white"
                                                : "bg-white text-[#022C22] border border-[#059669] hover:bg-[#F0FDF4]"}`, children: "Clinician Mode" })] }), activeTab === "roadmap" && (_jsxs("button", { onClick: handleQuickDemoAutoFill, className: "bg-[#1E3A5F] hover:bg-[#2E5A88] text-white font-bold rounded-lg px-4 py-2 transition-colors flex items-center gap-2 shadow-sm", children: [_jsx(Zap, { className: "w-4 h-4", strokeWidth: 1.75 }), "Auto-fill practice"] }))] })] }), activeTab === "roadmap" ? (_jsxs("div", { className: "space-y-6", children: [_jsx(GeneralizationGauge, { caseId: caseId, refreshTrigger: refreshKey }), learningPath.streak && (_jsx(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#064E3B] border border-[#0D9488] rounded-[16px] p-5 shadow-sm", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "p-2.5 bg-[#047857] border border-[#0D9488] rounded-full flex items-center justify-center", children: _jsx(Flame, { className: "w-6 h-6 text-[#F59E0B]", strokeWidth: 1.75 }) }), _jsxs("div", { children: [_jsxs("div", { className: "font-black text-xl text-white tabular-nums tracking-tight", children: ["Streak: ", learningPath.streak.current_streak_days, " days"] }), _jsx("div", { className: "text-sm font-bold text-[#CCFBF1]", children: "Practice today to maintain your streak" })] })] }) })), _jsx(Roadmap, { milestones: learningPath.milestones, onMilestoneClick: handleMilestoneClick, onUnlockMilestone: handleUnlockMilestone, progressData: progressData, refreshTrigger: refreshKey }), _jsx(BadgesShowcase, { caseId: caseId, refreshTrigger: refreshKey }), _jsx(AnimatePresence, { children: showCelebration && (_jsx(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -8 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#064E3B] border border-[#0D9488] rounded-[14px] p-4 text-center shadow-sm", children: _jsxs("div", { className: "flex items-center justify-center gap-2", children: [_jsx(CheckCircle2, { className: "w-5 h-5 text-[#34D399]", strokeWidth: 1.75 }), _jsx("span", { className: "font-black text-lg text-white", children: "Badge unlocked" }), _jsx(CheckCircle2, { className: "w-5 h-5 text-[#34D399]", strokeWidth: 1.75 })] }) })) }), _jsx(MilestoneCard, { milestone: selectedMilestone, onUnlockMilestone: handleUnlockMilestone, caseId: caseId, onProgressUpdate: handleProgressUpdate, onProbeComplete: handleProbeComplete, autoFillTrigger: autoFillTrigger })] })) : (_jsxs("div", { className: "relative", children: [_jsx(MilestoneEditor, { milestones: learningPath.milestones, onUpdateMilestone: handleUpdateMilestone, onAddMilestone: handleAddMilestone, onDeleteMilestone: handleDeleteMilestone, disabled: pathApproved }), !pathApproved && (_jsx("div", { className: "fixed bottom-0 left-0 right-0 bg-white border-t border-[#A7E3D5] p-4 shadow-md z-40", children: _jsx("div", { className: "max-w-6xl mx-auto flex justify-center", children: _jsxs("button", { onClick: handleApprovePath, className: "bg-[#1E3A5F] hover:bg-[#2E5A88] text-white font-semibold rounded-lg px-5 py-2.5 shadow-sm transition-colors flex items-center gap-2", children: [_jsx(CheckCircle2, { className: "w-5 h-5 text-white", strokeWidth: 1.75 }), "Approve & Lock Path"] }) }) })), pathApproved && (_jsx(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.2, ease: "easeOut" }, className: "fixed bottom-0 left-0 right-0 bg-[#CCFBF1] border-t border-[#0D9488] text-[#0F172A] p-4 shadow-md z-40", children: _jsxs("div", { className: "max-w-6xl mx-auto flex items-center justify-center gap-3", children: [_jsx(CheckCircle2, { className: "w-6 h-6 text-[#16A34A]", strokeWidth: 1.75 }), _jsx("span", { className: "font-bold text-lg text-[#0F172A]", children: "Path is live and approved" }), _jsx(CheckCircle2, { className: "w-6 h-6 text-[#16A34A]", strokeWidth: 1.75 })] }) }))] }))] }) }));
}
