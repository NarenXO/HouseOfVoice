...
export default function LearningPathPage() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50", children: [_jsx("div", { className: "bg-white border-b border-gray-200", children: _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "flex items-center justify-between h-16", children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Learning Path" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: () => setActiveTab("roadmap"), className: `px-4 py-2 rounded-lg font-medium transition-colors ${activeTab === "roadmap"
                                            ? "bg-blue-500 text-white"
                                            : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`, children: "My Roadmap" }), _jsx("button", { onClick: () => setActiveTab("edit"), className: `px-4 py-2 rounded-lg font-medium transition-colors ${activeTab === "edit"
                                            ? "bg-blue-500 text-white"
                                            : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`, children: "Edit Path" })] })] }) }) }), _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: activeTab === "roadmap" ? (_jsxs("div", { children: [_jsx("div", { className: "mb-6", children: _jsx(GeneralizationGauge, { caseId: caseId, refreshTrigger: refreshKey }) }), learningPath.streak && (_jsx(motion.div, { initial: { opacity: 0, y: -10 }, animate: { opacity: 1, y: 0 }, className: "bg-gradient-to-r from-orange-500 to-red-500 rounded-xl p-4 mb-6 text-white shadow-lg", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx(motion.div, { animate: {
                                            scale: [1, 1.1, 1],
                                            rotate: [0, 5, -5, 0]
                                        }, transition: {
                                            duration: 2,
