...
export default function PracticePanel({ milestone, caseId, onCheckpointReady, onProgressUpdate, onProbeComplete, autoFillTrigger }) {
    ...
    return (_jsxs("div", { className: "bg-white border border-[#A7E3D5] rounded-[14px] shadow-sm p-6", children: [_jsxs("div", { className: "mb-6", children: [_jsx("h3", { className: "text-xl font-bold text-[#0F172A] mb-1", children: milestone.title }), _jsx("p", { className: "text-sm font-medium text-[#334155] mb-4", children: milestone.goal }), _jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsxs("span", { className: "text-sm font-semibold text-[#0F172A]", children: ["Practice ", progress.consecutive_successes, " of ", threshold, " days to unlock checkpoint"] }), _jsxs("span", { className: "text-sm font-bold text-[#0D9488] tabular-nums", children: [progress.completed_exercises, "/", progress.total_exercises] })] }), _jsx("div", { className: "w-full bg-[#E2E8F0] h-2.5 rounded-full overflow-hidden", children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${progressPercentage}%` }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#0D9488] h-2.5 rounded-full" }) })] }), _jsx(AnimatePresence, { children: notification && (_jsx(motion.div, { initial: { opacity: 0, y: -8 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -8 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#CCFBF1] border border-[#0D9488] rounded-lg p-3 mb-4", children: _jsx("p", { className: "text-sm font-semibold text-[#0F172A]", children: notification }) })) }), progress.checkpoint_ready && (_jsx(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#CCFBF1] border border-[#0D9488] text-[#0F172A] rounded-[12px] p-4 mb-6 shadow-sm", children: _jsxs("div", { className: "flex items-start gap-4", children: [_jsx("div", { className: "p-2 bg-white border border-[#0D9488] rounded-full flex-shrink-0", children: _jsx(Target, { className: "w-6 h-6 text-[#0D9488]", strokeWidth: 1.75 }) }), _jsxs("div", { className: "flex-1", children: [_jsx("h4", { className: "font-bold text-[#0F172A] text-lg mb-1", children: "Checkpoint ready" }), _jsx("p", { className: "text-sm font-medium text-[#334155] mb-4", children: "You have completed the required practice sessions. Take the generalization probe to assess progress." }), _jsxs("button", { onClick: handleTakeCheckpoint, className: "bg-[#0D9488] hover:bg-[#0F766E] text-white font-semibold rounded-lg px-4 py-2 transition-colors flex items-center gap-2 shadow-sm", children: [_jsx(Target, { className: "w-5 h-5 text-white", strokeWidth: 1.75 }), "Take probe checkpoint"] })] })] }) })), _jsx("div", { className: "space-y-4 mb-6", children: exercises.map((exercise, index) => (_jsx("div", { className: `p-4 rounded-[12px] border transition-all ${exercise.done
                        ? "bg-[#CCFBF1] border-[#0D9488]"
                        : "bg-[#F0FDFA] border-[#A7E3D5]"}`, children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("h4", { className: `font-semibold mb-1 ${exercise.done ? "text-[#0F766E] line-through opacity-75" : "text-[#0F172A]"}`, children: ["Exercise ", index + 1, ": ", exercise.title] }), _jsx("p", { className: `text-sm ${exercise.done ? "text-[#0F766E] opacity-75" : "text-[#334155]"} font-medium`, children: exercise.instructions })] }), _jsx("div", { className: "ml-4", children: exercise.done ? (_jsx(motion.div, { initial: { scale: 0 }, animate: { scale: 1 }, transition: { duration: 0.2, ease: "easeOut" }, className: "flex items-center justify-center w-9 h-9 bg-[#16A34A] rounded-full", children: _jsx(CheckCircle2, { className: "w-5 h-5 text-white", strokeWidth: 1.75 }) })) : (_jsx("button", { onClick: () => handleMarkDone(index), className: "bg-[#1E3A5F] hover:bg-[#2E5A88] text-white font-semibold rounded-lg px-4 py-2 transition-colors shadow-sm", children: "Mark Done" })) })] }) }, exercise.id))) }), _jsxs("div", { className: "flex items-center justify-between pt-4 border-t border-[#CBD5E1]", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Flame, { className: "w-5 h-5 text-[#D97706]", strokeWidth: 1.75 }), _jsxs("span", { className: "text-[#0F172A] font-bold tabular-nums", children: ["Streak: ", streak?.current_streak_days || 0, " days"] })] }), _jsx("button", { onClick: () => {
                            setNotification("Practice session recorded");
                            setTimeout(() => setNotification(null), 3000);
                        }, className: "bg-[#0D9488] hover:bg-[#0F766E] text-white font-semibold rounded-lg px-4 py-2 shadow-sm transition-colors", children: "Record Practice Session" })] })] }));
}
