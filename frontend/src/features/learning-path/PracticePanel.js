...
export default function PracticePanel({ milestone, caseId, onCheckpointReady, onProgressUpdate, onProbeComplete, autoFillTrigger }) {
    ...
    return (_jsxs("div", { className: "bg-[#064E3B] border-2 border-[#0D9488] rounded-[16px] shadow-md p-6", children: [_jsxs("div", { className: "mb-6", children: [_jsx("h3", { className: "text-2xl font-black text-white tracking-tight mb-1", children: milestone.title }), _jsx("p", { className: "text-sm font-bold text-[#D1FAE5] mb-4", children: milestone.goal }), _jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsxs("span", { className: "text-sm font-extrabold text-white", children: ["Practice ", progress.consecutive_successes, " of ", threshold, " days to unlock checkpoint"] }), _jsxs("span", { className: "text-sm font-black text-[#CCFBF1] tabular-nums", children: [progress.completed_exercises, "/", progress.total_exercises] })] }), _jsx("div", { className: "w-full bg-[#022C22] h-2.5 rounded-full overflow-hidden border border-[#059669]", children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${progressPercentage}%` }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#34D399] h-2.5 rounded-full" }) })] }), _jsx(AnimatePresence, { children: notification && (_jsx(motion.div, { initial: { opacity: 0, y: -8 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -8 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#022C22] border border-[#059669] rounded-lg p-3 mb-4 shadow-sm", children: _jsx("p", { className: "text-sm font-extrabold text-white", children: notification }) })) }), progress.checkpoint_ready && (_jsx(motion.div, { initial: { opacity: 0, y: 8 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.2, ease: "easeOut" }, className: "bg-[#022C22] border-2 border-[#059669] text-white rounded-[12px] p-4 mb-6 shadow-sm", children: _jsxs("div", { className: "flex items-start gap-4", children: [_jsx("div", { className: "p-2 bg-[#064E3B] border border-[#0D9488] rounded-full flex-shrink-0", children: _jsx(Target, { className: "w-6 h-6 text-[#34D399]", strokeWidth: 1.75 }) }), _jsxs("div", { className: "flex-1", children: [_jsx("h4", { className: "font-black text-white text-lg mb-1", children: "Checkpoint ready" }), _jsx("p", { className: "text-sm font-extrabold text-[#D1FAE5] mb-4", children: "You have completed the required practice sessions. Take the generalization probe to assess progress." }), _jsxs("button", { onClick: handleTakeCheckpoint, className: "bg-white hover:bg-[#CCFBF1] text-[#064E3B] font-black rounded-lg px-4 py-2 transition-colors flex items-center gap-2 shadow-sm", children: [_jsx(Target, { className: "w-5 h-5 text-[#064E3B]", strokeWidth: 1.75 }), "Take probe checkpoint"] })] })] }) })), _jsx("div", { className: "space-y-4 mb-6", children: exercises.map((exercise, index) => (_jsx("div", { className: "bg-[#022C22] border border-[#059669] rounded-[12px] p-4 transition-all shadow-sm", children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { className: "flex-1", children: [_jsxs("h4", { className: `font-black mb-1.5 ${exercise.done ? "text-[#34D399] line-through opacity-80 text-base" : "text-base font-black text-white"}`, children: ["Exercise ", index + 1, ": ", exercise.title] }), _jsx("p", { className: `text-base font-extrabold ${exercise.done ? "text-[#D1FAE5] opacity-80" : "text-[#D1FAE5]"}`, children: exercise.instructions })] }), _jsx("div", { className: "ml-4", children: exercise.done ? (_jsx(motion.div, { initial: { scale: 0 }, animate: { scale: 1 }, transition: { duration: 0.2, ease: "easeOut" }, className: "flex items-center justify-center w-9 h-9 bg-[#34D399] rounded-full", children: _jsx(CheckCircle2, { className: "w-5 h-5 text-[#022C22]", strokeWidth: 2 }) })) : (_jsx("button", { onClick: () => handleMarkDone(index), className: "bg-white hover:bg-[#CCFBF1] text-[#064E3B] font-black rounded-lg px-4 py-2 transition-colors shadow-sm", children: "Mark Done" })) })] }) }, exercise.id))) }), _jsxs("div", { className: "flex items-center justify-between pt-4 border-t border-[#0D9488]", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Flame, { className: "w-5 h-5 text-[#F59E0B]", strokeWidth: 1.75 }), _jsxs("span", { className: "text-white font-black text-sm tabular-nums", children: ["Streak: ", streak?.current_streak_days || 0, " days"] })] }), _jsx("button", { onClick: () => {
                            setNotification("Practice session recorded");
                            setTimeout(() => setNotification(null), 3000);
                        }, className: "bg-white hover:bg-[#CCFBF1] text-[#064E3B] font-black rounded-lg px-4 py-2 shadow-sm transition-colors", children: "Record Practice Session" })] })] }));
}
