...
export default function GeneralizationGauge({ caseId, refreshTrigger = 0 }) {
    ...
    if (loading) {
        return (_jsx("div", { className: "bg-white border border-[#CBD5E1] rounded-[12px] p-6 shadow-sm", children: _jsx("div", { className: "flex items-center justify-center h-48", children: _jsx("div", { className: "text-[#475569]", children: "Loading generalization data..." }) }) }));
    }
    if (error || !data) {
        return (_jsx("div", { className: "bg-white border border-[#CBD5E1] rounded-[12px] p-6 shadow-sm", children: _jsx("div", { className: "flex items-center justify-center h-48", children: _jsx("div", { className: "text-[#DC2626]", children: error || "No data available" }) }) }));
    }
