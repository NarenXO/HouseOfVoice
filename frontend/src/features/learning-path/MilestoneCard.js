...
export default function MilestoneCard({ milestone, onUnlockMilestone, caseId, onProgressUpdate, onProbeComplete, autoFillTrigger }) {
    ...
    const getBanner = () => {
        if (milestone.status === "active") {
            return (_jsx("div", { className: "bg-[#064E3B] border border-[#0D9488] rounded-[12px] p-3 mb-4 shadow-sm", children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-2.5 h-2.5 bg-[#34D399] rounded-full" }), _jsx("span", { className: "text-sm font-extrabold text-white", children: "Current focus" })] }) }));
        }
        if (milestone.status === "generalized") {
            return (_jsx("div", { className: "bg-[#064E3B] border border-[#0D9488] rounded-[12px] p-3 mb-4 shadow-sm", children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Award, { className: "w-4 h-4 text-[#34D399]", strokeWidth: 1.75 }), _jsx("span", { className: "text-sm font-extrabold text-white", children: "Generalized" })] }) }));
        }
